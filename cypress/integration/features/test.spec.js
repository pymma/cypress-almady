...
context.skip('Driver', () => {
    ...
    describe('Driver List',() => {
        let email = 'kelvin.navet@gmail.com'
        let firstN  = 'Kelvin-7870'
        let LastN = 'NAVET'
        let Add = '6 rue de la fileuse 77310 ST FARGEAU PONTHIERRY'
        let pvJob = 'Forward Functionality Planner'
        ...
        it.skip('Change Vehicule Information',() => {
        ...
        it.skip('Reset Default previous job', () => {
            cy.get('button.btn.btn-secondary.btn-lg').contains('Change data').click()
            BasePage.pause(1000)
